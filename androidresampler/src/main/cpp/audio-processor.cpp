...
Java_io_github_nailik_androidresampler_processor_OboeAudioProcessor_initProcessor(
        JNIEnv* env,
        jobject /* this */,
        jint quality,
    ...
    resamplerInputBuffer = new float[inputChannelCount];
    resamplerOutputBuffer = new float[outputChannelCount];
}

extern "C" JNIEXPORT int JNICALL
Java_io_github_nailik_androidresampler_processor_OboeAudioProcessor_processAudioFrame(
        JNIEnv* env,
        jobject,
...
extern "C" JNIEXPORT void JNICALL
Java_io_github_nailik_androidresampler_processor_OboeAudioProcessor_releaseProcessor(
        JNIEnv* env,
        jobject /* this */) {
